...
**Afiliación:** Institute For Plasma Research, India
**Grabación / Diapositivas:** [Descargar slides en PDF](#)  

![Cartel de la charla]({{ '/assets/images/charla_2.png' | relative_url }}){: .align-center style="max-width: 500px;"}
